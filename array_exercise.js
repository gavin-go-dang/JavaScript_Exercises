var numberArray = [1, 5, 13, 6, 9, 22, 24, 21, 101, 100, 200, 4, 7, 7, 12];
const firstArray = document.getElementById('first_array');
...
const greaterThan10Elelemt_1 = document.getElementById('element_greater_than_10_1');
...
const greaterThan10_2 = document.getElementById('element_greater_than_10_2');
greaterThan10_2.innerHTML = filteringArrayGreaterThan_10_2;
greaterThan10_2.innerHTML = numberArray
...
const sumArray1 = document.getElementById('sum_array_1');
...
const sumArray2 = document.getElementById('sum_array_2');
...
var doubleValuesElement1 = document.getElementById('double_value_1');
...
const doubleValuesElement2 = document.getElementById('double_value_2');
...
const joinArrayElement_1 = document.getElementById('join_array_1');
...
const joinArrayElement_2 = document.getElementById('join_array_2');
...
var user = {'fname' : 'Van A', 'lname' : 'Nguyen'}
